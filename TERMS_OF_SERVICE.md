...
These Terms of Service ("Terms") govern access to and use of the Agent Governance APIs, SDK, website, and related services (collectively, the "Services") provided by Homer Semantics ("we", "us", "our"). By installing this SDK, creating a hosted trial session, using an API key, or otherwise using the Services, you agree to these Terms.
...
You must be legally able to enter into these Terms. You are responsible for all activity under your account, hosted trial sessions, and API keys. You must keep credentials secure and notify us promptly of unauthorized use.

## 2. License and Service Access

Your use of the SDK is subject to the applicable license for this package. We grant you a limited, revocable, non-exclusive right to access and use the Services in accordance with these Terms, your plan limits, and applicable law.
...
3. Attempt model, prompt, or dataset extraction, or systematic output analysis intended to replicate Agent Governance or Cerone functionality.
...
The hosted Agent Governance / Cerone trial currently includes up to 2,500 validations, with a safety stop that may apply before the hard cap.

After the trial is exhausted or stopped, continued API usage may require an active paid plan or may be subject to reduced or zero quota, at our discretion unless otherwise stated in a signed commercial agreement.

Unused trial validations do not roll over. We may modify, suspend, or discontinue free-tier or trial offerings at any time.
...
We may suspend or terminate access immediately for suspected abuse, security risk, non-payment, legal risk, or breach of these Terms or the applicable SDK license. On termination, your right to use the Services ceases immediately.
